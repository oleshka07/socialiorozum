...
## Corpus Check
- 63 files · ~151,330 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1279 nodes · 2877 edges · 123 communities (63 shown, 60 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 16 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `05bbf128`
...
## Communities (123 total, 60 thin omitted)
...
Cohesion: 0.09
Nodes (72): stockPhotoOptions(), chat(), extractJsonArray(), extractJsonObject(), adaptForChannels(), AI_TRACE_RX, aiAudit(), atomizePost() (+64 more)
...
Cohesion: 0.18
Nodes (19): applyState(), badge(), ensureRun(), genIdeas(), genPosts(), go(), ideaOpts(), refresh() (+11 more)
...
Cohesion: 0.07
Nodes (39): startAutopost(), tick(), one(), ensureIgSafeImage(), DEFAULT_PROMPTS, STEP_ORDER, StepKey, alreadySentNetworks() (+31 more)

### Community 41 - "Community 41"
Cohesion: 0.10
Nodes (38): $(), applyState(), buildTzSel(), ensureLangOption(), esc(), loadBroll(), loadGdrive(), loadGdriveFolders() (+30 more)
...
Cohesion: 0.07
Nodes (51): $(), applyPlanFilter(), bindIbAdd(), buildTzSel(), ensureLangOption(), flyPoints(), loadAccount(), loadAnalytics() (+43 more)
...
Cohesion: 0.14
Nodes (21): api(), finishOnboarding(), flashSaved(), loadFF(), loadImageProvider(), loadPrompts(), loadRubrics(), loadStrategy() (+13 more)

### Community 101 - "Community 101"
Cohesion: 0.15
Nodes (14): esc(), loadGdrive(), loadGdriveFolders(), loadLinkedin(), loadMedia(), loadMeta(), loadMetaPages(), loadRecent() (+6 more)

### Community 102 - "Community 102"
Cohesion: 0.22
Nodes (8): pool, env, __dirname, ChatCtx, GEMINI_PRICES, geminiChat(), OPENAI_PRICES, stripDashes()

### Community 104 - "Community 104"
Cohesion: 0.14
Nodes (36): aiBusy(), aiDone(), api(), bulkDelete(), bulkReview(), deletePost(), developPost(), directorCheck() (+28 more)

### Community 105 - "Community 105"
Cohesion: 0.31
Nodes (8): thValidToken(), getSetting(), getSettingText(), setSetting(), localParts(), processDailyTakes(), processReplyJobs(), startThreadsAuto()
...
Cohesion: 0.19
Nodes (28): aiBusy(), aiDone(), badge(), bulkDelete(), bulkReview(), deletePost(), developPost(), directorCheck() (+20 more)
...
- **Why does `q()` connect `Auth, Session & Workers` to `Community 96`, `Community 100`, `Google Drive Integration`, `Community 102`, `Community 39`, `Community 104`, `Community 40`, `Community 106`, `Community 43`, `Community 12`, `Community 109`, `LLM Routing & AI`, `Community 105`, `Community 15`, `Authentication & Users`?**
  _High betweenness centrality (0.335) - this node is a cross-community bridge._
- **Why does `renderTaskStrip()` connect `Community 96` to `Community 8`, `Auth, Session & Workers`, `Community 101`?**
  _High betweenness centrality (0.113) - this node is a cross-community bridge._
- **Why does `renderTaskStrip()` connect `Community 106` to `Auth, Session & Workers`, `Community 9`, `Community 41`?**
