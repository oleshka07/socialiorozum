# Graph Report - socialiorozum  (2026-07-25)

## Corpus Check
- 63 files · ~157,979 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1298 nodes · 2921 edges · 126 communities (66 shown, 60 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 16 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bc8ac048`
...
## Communities (126 total, 60 thin omitted)

### Community 0 - "Auth, Session & Workers"
Cohesion: 0.19
Nodes (17): createEmailToken(), createSession(), createUser(), createWorkspaceWithDefaults(), deleteSession(), findOrCreateGoogleUser(), hashPassword(), markVerified() (+9 more)
...
Cohesion: 0.12
Nodes (30): Aspect, ASPECT_DIM, attachCroppedImage(), attachStockPhoto(), charFrac(), cleanupDerivedMedia(), COSTS, CropRect (+22 more)

### Community 5 - "LLM Routing & AI"
Cohesion: 0.16
Nodes (31): stockPhotoOptions(), chat(), extractJsonArray(), extractJsonObject(), aiAudit(), atomizePost(), buildLiteSkeleton(), deAiFix() (+23 more)

### Community 6 - "Authentication & Users"
Cohesion: 0.07
Nodes (42): businessDiscovery(), exchangeCode(), exchangeLongLived(), fbFetch(), FbPage, igStats(), pageStats(), publishPhotoToPage() (+34 more)
...
Cohesion: 0.03
Nodes (68): chanDots(), ChanStatus, CP_ICON, CP_LABEL, CP_LBL, CTA_TYPES, CtaCfg, DAY_LBL (+60 more)
...
Cohesion: 0.21
Nodes (15): weekDiary(), findBreakout(), localParts(), plusDay(), sendDigest(), sendDigestNow(), tick(), BenchPost (+7 more)
...
Cohesion: 0.08
Nodes (30): AI_TRACE_RX, CHANNEL_PLAYBOOK, ContentFormat, DEFAULT_PROMPTS, executeStep(), fillPrompt(), FORMAT_FROM_UA, FORMAT_LABELS (+22 more)
...
Cohesion: 0.16
Nodes (33): appendDiaryText(), attachDiaryMedia(), buildQuestion(), diaryButtons(), DiaryState, EVENING_Q, getState(), isDiaryPending() (+25 more)

### Community 40 - "Community 40"
Cohesion: 0.06
Nodes (33): startAutopost(), startDiary(), startDigest(), STEP_ORDER, StepKey, reelPubJobs, app, cancelRun (+25 more)

### Community 41 - "Community 41"
Cohesion: 0.09
Nodes (40): $(), applyState(), badge(), buildTzSel(), ensureLangOption(), flyPoints(), loadAccount(), loadAnalytics() (+32 more)
...
Cohesion: 0.16
Nodes (21): userByEmail(), userBySession(), tick(), one(), ensureIgSafeImage(), alreadySentNetworks(), freshToken(), publishPostToChannels() (+13 more)

### Community 96 - "Community 96"
Cohesion: 0.07
Nodes (48): $(), applyPlanFilter(), applyState(), buildTzSel(), ensureLangOption(), loadBroll(), loadChannelPlan(), loadFF() (+40 more)
...
Cohesion: 0.25
Nodes (17): adaptForChannels(), brandDna(), buildLeadMagnet(), buildLitePrompt(), expandTake(), extractIdeasFromText(), generateThreadsTakes(), goalRule() (+9 more)

### Community 102 - "Community 102"
Cohesion: 0.12
Nodes (28): api(), esc(), flashSaved(), loadAccount(), loadChanStatus(), loadGdrive(), loadGdriveFolders(), loadLinkedin() (+20 more)

### Community 104 - "Community 104"
Cohesion: 0.23
Nodes (21): aiBusy(), aiDone(), bulkDelete(), bulkReview(), deletePost(), developPost(), directorCheck(), expandToThread() (+13 more)
...
Cohesion: 0.12
Nodes (19): bindIbAdd(), closePop(), flyPoints(), loadAnalytics(), loadIdeasTab(), loadMaterials(), loadPlans(), loadTasks() (+11 more)
...
Cohesion: 0.26
Nodes (15): badge(), ensureRun(), finishOnboarding(), genIdeas(), genPosts(), go(), ideaOpts(), refresh() (+7 more)
...
Cohesion: 0.16
Nodes (31): aiBusy(), aiDone(), bulkDelete(), bulkReview(), deletePost(), developPost(), directorCheck(), ensureRun() (+23 more)
...
Cohesion: 0.29
Nodes (9): splitDiaryTopics(), Folder, pullFolder(), pullGdriveFolder(), startGdrivePoller(), tick(), validToken(), logEvent() (+1 more)

### Community 123 - "Community 123"
Cohesion: 0.15
Nodes (16): applyPlanFilter(), bindIbAdd(), loadMaterials(), loadPlan(), planSyncMode(), renderIdeaBank(), renderMaterials(), renderPlan() (+8 more)

### Community 124 - "Community 124"
Cohesion: 0.27
Nodes (5): pool, DEFAULT_RUBRICS, DEFAULT_SETTINGS, env, __dirname
...
## Knowledge Gaps
- **413 isolated node(s):** `Rubrics`, `ChanStatus`, `ThStrat`, `Pub`, `NETS` (+408 more)
...
- **Why does `q()` connect `Auth, Session & Workers` to `Community 100`, `Google Drive Integration`, `Community 102`, `Community 39`, `LLM Routing & AI`, `Community 41`, `Community 106`, `Community 43`, `Community 12`, `Community 105`, `Community 101`, `Community 15`, `Community 40`, `Community 18`, `Community 122`, `Community 124`, `Community 125`, `Authentication & Users`?**
  _High betweenness centrality (0.330) - this node is a cross-community bridge._
- **Why does `renderTaskStrip()` connect `Community 106` to `Community 8`, `Auth, Session & Workers`, `Community 96`, `Community 102`?**
